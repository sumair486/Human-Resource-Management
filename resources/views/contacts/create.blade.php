        ...
        <div class="card">
             <div class="header">
                ...
                <ul class="header-dropdown">
                    ...
                    <li><a style="font-weight:700; color:white; margin-left:20px; text-decoration:none;" href="{{url('blogs')}}">All Contacts</a></li>
                ...
                <div class="card-body p-0">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="category_id" id="category_id" placeholder="Blog Category" required="">
                            <span id="err-category_id" class="invalid-feedback" style="display: block" role="alert">
                                <strong></strong>
                            </span>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" placeholder="Meta Keywords" class="form-control" />
                            <span id="err-meta_keywords" class="invalid-feedback" style="display: block" role="alert">
                                <strong></strong>
                            </span>
                        </div>
