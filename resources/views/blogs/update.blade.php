                    ...
                    <div class="card-body p-0">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="blog_title" placeholder="Blog title" value="{{$blog->blog_title}}">
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <input type="text" name="meta_title" class="form-control" placeholder="Meta Title" value="{{$blog->meta_title}}" required="">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="long_description" class="summernote form-control">{{$blog->long_description}}</textarea>
                         	...
                         	<div class="form-group col-md-6">
                                ...
                                <textarea name="meta_description" class="summernote form-control">{{$blog->meta_description}}</textarea>
                        ...
                        <div class="form-row">
                           <div class="form-group col-md-6">
                                <label>Image</label>
                                <input type="file" name="image" class="form-control" placeholder="Blog Title"value="{{$blog->image}}" >
                                <span id="err-image" class="invalid-feedback" style="display: block" role="alert">
                                    <strong></strong>
                                </span>
                           </div> 
                           <div class="form-group col-md-6">
                                <label>Kaywords</label>
                                <input type="text" name="keywords" class="form-control" placeholder="Comma seperated value" value="{{$blog->keywords}}" required="">
                                <span id="err-title" class="invalid-feedback" style="display: block" role="alert">
                                    <strong></strong>
                                </span>
                            </div>  
