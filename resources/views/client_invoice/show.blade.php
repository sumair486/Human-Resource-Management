...
.footer-sec {
    background-image: url(https://app.tenetsys.com/public/img/footer1_1.png);
...
.banner-box {
    ...
    background-image: url(https://app.tenetsys.com/public/img/header1_1.png);
    background-size: cover;
    background-repeat: no-repeat;
    padding-top: 12px;
                    ...
                    <div class="container mt-5" >
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-xl-5 col-xxl-5 col-md-5 col-sm-6" id="company_info">
                                <img src="{{asset('img/tenet-logo.png')}}" style="width:70%";/>
                                <div class="divaction graycol">
                                        <h5 class="headzero"  style="font-size: 17px; margin-right: -10px; color:black">From:</h5>
                                </div>
                                <div class="divaction">
                                    <h5><strong>Tenet System</strong></h5>
                                    <div class="graycol">
                                        <h5 class="marz_1"></h5>
                                        <h5 class="marz">Phone: +971 50 283 6750</h5>
               							<h5 class="marz">Email: info@tenetsys.com</h5>
